...
#include "bse/msg/BJSBSDBFMsgFormatter.h"
...
BJSBSDBFMsg::~BJSBSDBFMsg() = default;

void BJSBSDBFMsg::parseFrom(dbf::DBFBuffer &buff) {
...
void BJSBSDBFMsg::serializeTo(dbf::DBFBuffer &buff) const {
  ...
  buff.appendString<1>(bYZD_);
}

void BJSBSDBFMsg::parseFromJson(const nlohmann::json &j) { *this = j; }

void BJSBSDBFMsg::serializeToJson(nlohmann::json &j) const { j = *this; }

std::string BJSBSDBFMsg::toString() const { return fmt::format("{}", *this); }
