#ifndef BSE_MSG_B_J_S_B_S_D_B_F_MSG_JSON_SERIALIZER_H
#define BSE_MSG_B_J_S_B_S_D_B_F_MSG_JSON_SERIALIZER_H
...
#include "BJSBSDBFMsg.h"

namespace nlohmann {
template <> struct adl_serializer<bse::msg::BJSBSDBFMsg> {
  static void from_json(const json &j, bse::msg::BJSBSDBFMsg &msg) {
    if (j.contains("ZJJS")) {
  ...
  static void to_json(json &j, const bse::msg::BJSBSDBFMsg &msg) {
    j["ZJJS"] = msg.zJJS();
    j["YWLB"] = msg.yWLB();
    j["WTLX"] = msg.wTLX();
    j["WTXH"] = msg.wTXH();
